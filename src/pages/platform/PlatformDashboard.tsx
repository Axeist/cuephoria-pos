...
const PlatformDashboard: React.FC = () => {
  ...
  const isOrgsPage = pathname.includes("/organizations");
        ...
        <div className="relative flex flex-wrap items-end justify-between gap-4">
          <div className="min-w-0">
            ...
            <p className="mt-1.5 text-sm text-zinc-400 max-w-xl">
              {isOrgsPage
                ? "Every gaming cafe running Cuetronix right now, at a glance. Click any tenant to drill into members, branding, subscription, and audit trail."
                : "Internal system metrics, feature flags, sandbox overrides, and fleet-wide configurations."}
            </p>
          </div>
