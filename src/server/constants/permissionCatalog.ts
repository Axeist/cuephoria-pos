...
export const PERMISSION_CATALOG: PermissionMeta[] = [
  ...
  { key: 'bookings.coupons_manage', groupLabel: 'Bookings', label: 'Manage coupons (legacy)', requiresPlan: 'bookings_enabled' },
  { key: 'coupons.manage', groupLabel: 'Coupons', label: 'Manage promo coupons', requiresPlan: 'bookings_enabled' },
  ...
  { key: 'tournaments.view', groupLabel: 'Tournaments', label: 'View tournaments & TV boards' },
  { key: 'tournaments.create', groupLabel: 'Tournaments', label: 'Create tournaments' },
  { key: 'tournaments.edit', groupLabel: 'Tournaments', label: 'Edit events, players & fixtures' },
  { key: 'tournaments.results', groupLabel: 'Tournaments', label: 'Record match results & lap times' },
  { key: 'tournaments.complete', groupLabel: 'Tournaments', label: 'Mark complete / reopen events' },
  { key: 'tournaments.delete', groupLabel: 'Tournaments', label: 'Delete tournaments' },
  { key: 'tournaments.gallery', groupLabel: 'Tournaments', label: 'Manage gallery & photos' },
  { key: 'tournaments.leaderboard.reset', groupLabel: 'Tournaments', label: 'Reset leaderboard' },
  { key: 'memberships.view', groupLabel: 'Memberships', label: 'View memberships hub' },
  { key: 'memberships.tiers.edit', groupLabel: 'Memberships', label: 'Manage tier plans' },
  { key: 'memberships.recharge.edit', groupLabel: 'Memberships', label: 'Manage recharge tiers' },
  { key: 'memberships.recharge.execute', groupLabel: 'Memberships', label: 'Execute recharges' },
  { key: 'memberships.cards.manage', groupLabel: 'Memberships', label: 'Manage NFC cards' },
  { key: 'memberships.coupons.edit', groupLabel: 'Memberships', label: 'Manage member coupons' },
  { key: 'memberships.settings.edit', groupLabel: 'Memberships', label: 'Membership settings & flags' },
  { key: 'memberships.customers.edit', groupLabel: 'Memberships', label: 'Edit member profiles' },
...
export const DEFAULT_ROLE_PERMISSIONS: Record<SystemRoleSlug, string[]> = {
  ...
  venue_admin: P(
    ...
    'bookings.view', 'bookings.create', 'bookings.edit', 'bookings.cancel', 'bookings.check_in', 'bookings.reconciliation', 'bookings.coupons_manage', 'bookings.slots_configure', 'bookings.popups_manage', 'coupons.manage',
    'tournaments.view', 'tournaments.create', 'tournaments.edit', 'tournaments.results', 'tournaments.complete', 'tournaments.delete', 'tournaments.gallery', 'tournaments.leaderboard.reset',
    'memberships.view', 'memberships.tiers.edit', 'memberships.recharge.edit', 'memberships.recharge.execute', 'memberships.cards.manage', 'memberships.coupons.edit', 'memberships.settings.edit', 'memberships.customers.edit',
  ...
  shift_manager: P(
    ...
    'tournaments.view', 'tournaments.results', 'tournaments.complete', 'tournaments.leaderboard.reset',
    'memberships.view', 'memberships.recharge.execute', 'memberships.cards.manage',
  ),
  employee: P(
    'dashboard.view',
    ...
    'settings.general.view', 'tournaments.view',
  ),
  accountant: P(
