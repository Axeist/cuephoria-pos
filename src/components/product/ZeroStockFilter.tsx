...
const ZeroStockFilter: React.FC<ZeroStockFilterProps> = ({
  ...
  return (
    <div className="flex items-center space-x-2 px-3 py-2 bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800 rounded-md">
      <Checkbox
        id="zero-stock-filter"
        checked={showZeroStockOnly}
        onCheckedChange={onToggle}
      />
      <Label 
        htmlFor="zero-stock-filter" 
