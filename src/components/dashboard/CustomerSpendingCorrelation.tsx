    ...
    return (
      <Card className="bg-gradient-to-br from-gray-900/95 to-gray-800/90 border-gray-700/50 shadow-xl hover:shadow-purple-500/20 hover:border-purple-500/30 transition-all duration-300 backdrop-blur-sm">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4 border-b border-gray-700/30">
          <div>
            <CardTitle className="text-lg font-semibold text-white">Customer Spending Analysis</CardTitle>
        ...
        <CardContent className="h-[300px] flex items-center justify-center p-6">
          <div className="bg-gray-800/50 rounded-lg p-8 border border-gray-700/30 text-center">
            <TrendingUp className="h-8 w-8 text-gray-500 mx-auto mb-3" />
            <p className="text-sm text-gray-400">Not enough customer data to display correlation</p>
          </div>
        </CardContent>
      </Card>
    );
