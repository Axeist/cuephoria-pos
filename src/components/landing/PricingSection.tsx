...
const PLANS = [
  ...
  },
  {
    ...
    features: [
      ...
      "5 admin seats",
      "Online bookings + POS",
      "Loyalty, memberships & tournaments",
      "CSV exports",
      "Custom font + priority support",
      "No staff HR / payroll",
    ],
  },
  {
    ...
    features: [
      ...
      "Staff attendance + payroll + payslips",
      "Advanced analytics & multi-branch reporting",
