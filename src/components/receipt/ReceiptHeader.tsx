    ...
    return (
      <div className="border-b-2 border-dashed border-gray-400 pb-4 mb-4">
        <div className="text-center mb-4">
          <h1
            className="text-4xl font-bold text-cyan-700 mb-1"
            style={{ fontFamily: 'Arial Black, sans-serif' }}
          >
            CUEPHORIA LITE
          </h1>
          <p className="text-sm text-gray-600 uppercase tracking-wider">Gaming · Lite Branch</p>
        </div>
        ...
        <div className="text-center space-y-1 text-xs text-gray-700 mb-4">
          <div className="flex items-center justify-center gap-1">
            ...
            <p>
              Roof Top, No.1, Shivani Complex, Vaithiyalingam St,
              <br />
          ...
          <div className="flex items-center justify-center gap-1 mt-2">
            <Phone className="h-3 w-3 text-cyan-700" />
            <span className="font-semibold">+91 75500 25155</span>
          </div>
