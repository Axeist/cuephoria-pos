  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month: "space-y-4 w-full max-w-sm mx-auto sm:max-w-none",
        ...
        head_row: "flex",
        head_cell:
          "text-muted-foreground rounded-md w-8 sm:w-9 font-normal text-[0.8rem] flex items-center justify-center",
